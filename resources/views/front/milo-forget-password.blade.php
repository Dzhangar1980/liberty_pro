...
<head>
    ...
    <title>Liberty Club :: Восстановление пароля</title>
...
<body>
	<div id="page-wrapper">
        ...
        <!-- CONTENT -->
        <div class="content"> 
            <section class="full-section" style="background-image:url(milo/images/backgrounds/nature.jpg);">
            	<div class="container">
                    <div class="row">
                        <div class="col-sm-12">                        	
